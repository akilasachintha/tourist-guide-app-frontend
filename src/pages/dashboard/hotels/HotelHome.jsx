        ...
        <div className="flex flex-row rounded-lg border border-gray-200/80 bg-white p-6">
          ...
          <div className="flex flex-col px-6">
            <div className="flex h-8 flex-row">
              <h2 className="text-lg font-semibold">{appUser.name}</h2>
            ...
            <div className="my-2 flex flex-row space-x-2">
              <div className="flex flex-row">
                ...
                <div className="text-xs text-gray-400/80 hover:text-gray-400">{appUser.userType}</div>
              </div>
              <div className="flex flex-row">
                <svg className="mr-2 h-4 w-4 fill-gray-500/80" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" width={24} height={24} viewBox="0 0 24 24">
                  <path d="M12,6.5A2.5,2.5 0 0,1 14.5,9A2.5,2.5 0 0,1 12,11.5A2.5,2.5 0 0,1 9.5,9A2.5,2.5 0 0,1 12,6.5M12,2A7,7 0 0,1 19,9C19,14.25 12,22 12,22C12,22 5,14.25 5,9A7,7 0 0,1 12,2M12,4A5,5 0 0,0 7,9C7,10 7,12 12,18.71C17,12 17,10 17,9A5,5 0 0,0 12,4Z" />
                </svg>
                <div className="text-xs text-gray-400/80 hover:text-gray-400">{appUser.dob}</div>
              </div>
              ...
              <div className="flex flex-row">
                ...
                <div className="text-xs text-gray-400/80 hover:text-gray-400">{appUser.email}</div>
              </div>
            </div>
            ...
            <div className="mt-2 flex flex-row items-center space-x-5">
              ...
              <Link to="/dashboard/drivers/vehicles">
                <div
                  ...
                  <div className="flex flex-row items-center justify-center">
                    ...
                    <span className="font-bold text-gray-600"> {hotels.length} </span>
                  </div>
                  <div className="mt-2 text-sm text-gray-400">Hotels</div>
                </div>
              </Link>
              ...
              <div
                ...
                <div className="mt-2 text-sm text-gray-400">Notifications</div>
              </div>
              ...
              <div className="flex h-20 w-40 flex-col items-center justify-center rounded-md border border-dashed border-gray-200 transition-colors duration-100 ease-in-out hover:border-gray-400/80">
                ...
                <div className="mt-2 text-sm text-gray-400">Rate</div>
              </div>
            </div>
          </div>
          ...
          <div className="w-100 flex flex-grow flex-col items-end justify-start">
            <div className="flex flex-row space-x-3">
              ...
              <Link to="/dashboard/hotels/profile">
                <button
