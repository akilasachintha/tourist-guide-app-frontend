      ...
      <div className="mx-20 grid">
        ...
        <div className="flex flex-row rounded-lg border border-gray-200/80 bg-white p-6">
          ...
          <div className="relative">
            ...
            <img className="rounded-md object-cover" src="https://api.lorem.space/image/face?w=500&h=500" alt="User" />
          ...
          <div className="flex flex-col px-6">
            ...
            <div className="flex h-8 flex-row">
              ...
              <svg className="my-auto ml-2 h-5 fill-blue-400" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" width={24} height={24} viewBox="0 0 24 24">
          ...
          <div className="w-100 flex flex-grow flex-col items-end justify-start">
            <div className="flex flex-row space-x-3">
              ...
              <button className="flex rounded-md bg-blue-500 py-2 px-4 text-white transition-all duration-150 ease-in-out hover:bg-blue-600">
                <svg className="mr-2 fill-current" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" width={24} height={24} viewBox="0 0 24 24">
