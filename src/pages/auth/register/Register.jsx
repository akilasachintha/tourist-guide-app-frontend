                  ...
                  <div className="md:flex w-full">
                      ...
                      <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                          <div className="text-center mb-1">
                              <h1 className="font-bold text-3xl text-gray-900">Create New Account</h1>
                          ...
                          <div>
                              ...
                              <div className="flex">
                                  <div className="w-100 mb-1 px-1">
                                      ...
                                      <input className="form-control block w-full px-3 py-2 text-base font-normal text-gray-700 bg-white border-2 border-gray-200 rounded
     
      m-0
      focus:text-gray-700 focus:bg-white focus:border-indigo-500 focus:outline-none" type="file" id="formFile" />
                                  </div>
                              </div>
                              <div>
                                  ...
                                  <div className="flex -mx-3">
                                      <div className="w-1/4 px-3 mb-1">
                                          ...
                                          <div className="relative" placeholder="+94">
                                              <select
                                                  className="mt-1 mb-1 pl-10 bg-white w-100 appearance-none rounded-md border-2 border-gray-200 py-2.5 px-3 pr-8 leading-tight text-gray-700 focus:border-indigo-500 focus:bg-white focus:outline-none"
                                                  id="grid-state"
                                      ...
                                      <div className="w-3/4 px-3 mb-1">

                                          <div className="flex">
                                              <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"></div>
                                              <input type="text" className="w-full -ml-10 pl-10 pr-8 py-2.5 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" />
                                          </div>
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div className="flex -mx-3">
                                  <div className="w-full px-3 mb-5">
                                      <button className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg pl-10 px-3 py-3 font-semibold">REGISTER NOW</button>
                                  </div>
                              </div>
                          </div>
                      </div>
