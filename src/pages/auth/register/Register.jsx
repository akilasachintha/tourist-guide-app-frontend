...
const Register = () => {
  ...
  return (
    <div>
      <div className="min-w-full min-h-full bg-white flex items-center justify-center">
        <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden"
          ...
          <div className="md:flex w-full">
            ...
            <form className="w-full md:w-1/2 py-10 px-5 md:px-10" onSubmit={formik.handleSubmit}>
                ...
                <div className="w-full px-3 mb-1">
                  ...
                  <div className="flex">
                    ...
                    <input type="text"
                           ...
                           placeholder="john Smith" onChange={formik.handleChange}
                ...
                <div className="w-full px-3 mb-1">
                  ...
                  <div className="flex">
                    ...
                    <input type="email"
                           name="email"
                           className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                           placeholder="johnsmith@example.com" onChange={formik.handleChange}
                    ...
                    <div className="w-3/4 px-3 mb-1">
                      ...
                      <div className="flex">
                        <div
                          className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"></div>
                        <input type="text"
                               className="w-full -ml-10 pl-10 pr-8 py-2.5 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                               name="phoneNo"
