      ...
      <Formik initialValues={{
              ...
              }}>
        {
          ({
            ...
            <form className="min-w-full min-h-full bg-white flex items-center justify-center" onSubmit={handleSubmit}>
                  ...
                  <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                      ...
                      <div className="w-full px-3 mb-1">
                        ...
                        <div className="flex">
                          ...
                          <input type="email"
                                 name="email"
                                 className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                 placeholder="johnsmith@example.com" onChange={handleChange}
                                 value={values.email} />
                        </div>
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="relative" placeholder="Select your role">
                        ...
                        <div
                          className="text-white-700 pointer-events-none absolute inset-y-0 right-0 flex items-center px-2">
                          <svg
