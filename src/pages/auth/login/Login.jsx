        ...
        <div
          ...
          <div
            ...
            <button
              ...
              type="button"
              className="mt-3 flex w-full items-center rounded-lg border border-gray-700 p-3 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-offset-1"
            >
              <svg
                width={19}
                height={20}
            ...
            <button
              ...
              type="button"
              className="mt-4 flex w-full items-center rounded-lg border border-gray-700 p-3 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-offset-1"
            >
              <svg
                width={21}
                height={20}
          ...
          <div className="ml-8 mt-6 md:mt-0 md:w-1/2 lg:ml-16 xl:w-1/3">
            ...
            <div className="mt-10 flex items-center pl-8">
              ...
              <div className="ml-2">
                ...
                <p className="mt-1 cursor-pointer text-sm font-medium leading-none text-gray-600 hover:underline">
                  See profile
                </p>
              </div>
            </div>
