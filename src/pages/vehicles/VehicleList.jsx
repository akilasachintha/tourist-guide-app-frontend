...
import {getVehicles} from '../../redux/slices/locationApiHandle';
...
function VehicleList() {
    ...
    return (
        <div className="container mt-4 px-xl-5">
                        ...
                        >
                            {
                                vehicles.map((vehicle) => {
                                    if (viewType.grid) {
                                        return (
                                            <Vehicle key={vehicle.vehicleId}
                                                     percentOff={vehicle.vehicleId % 2 === 0 ? 15 : null}/>
                                        );
                                    }
                                    return (
                                        <VehicleH key={vehicle.vehicleId}
                                                  percentOff={vehicle.vehicleId % 4 === 0 ? 15 : null}/>
                                    );
                                })}
                        </div>
                    </div>
